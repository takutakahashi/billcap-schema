module github.com/takutakahashi/billcap-schema
...
require (
	github.com/goccy/bigquery-emulator v0.4.4
...
require (
	...
	github.com/goccy/go-zetasql v0.5.4 // indirect
	github.com/goccy/go-zetasqlite v0.17.3 // indirect
